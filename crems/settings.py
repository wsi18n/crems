"""
Django settings for crems project.
...
SECRET_KEY = '3(-kezp$p2chtb%9!b%d!7bq+ju_(60gf-e#7p7vtl6bqsvck!'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware', # enable CorsMiddleware , must be above CommonMiddleware
...
WSGI_APPLICATION = 'crems.wsgi.application'
...
JWT_AUTH = {
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'users.custom_jwt.jwt_response_payload_handler',
...
LOGGING = {
    ...
    'handlers': {
        ...
        'error': {
            ...
            'filename': '/var/log/crems/crems_error.log',
            'formatter': 'verbose'
        },
        'info': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': '/var/log/crems/crems_info.log',
            'formatter': 'simple'
        }
    },
    'loggers': {
